...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (strlen($post_title) <= 0) {
        ...
        $_SESSION["Error message"] = "Saississez le titre de la publication";
    } elseif (empty($post_content)) {
        $_SESSION["Error message"] = "Saississez le contenu de la publication";
    } else {
...
<div class="container homeContainer w-80 mx-auto">
    ...
    <br>
    <?php if (strlen($_SESSION["Error message"]) > 0) { ?>
        <?php echo '<div class="alert alert-danger w-50 mx-auto" role="alert"><strong>' . $_SESSION["Error message"] . '</strong></div>'; ?>
    <?php } ?>
</div>
<br>
